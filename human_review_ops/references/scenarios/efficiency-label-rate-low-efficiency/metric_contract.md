...
详细阈值由 `analysis.md` 维护，默认来源于已验证的 `low-efficiency-strategy-analysis/references/grading_rules.md`。
...
- 业务解释 Owner：人审运营效率治理 Owner，负责解释低效 reason 波动原因、确认治理动作和升级路径。
